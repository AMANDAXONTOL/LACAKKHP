...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;95m➣ \033[1;92mTOOLS      :            LACAK HP MU YANG HILANG 100% AKURAT
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		...
		print("\n\x1b[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••  ")
		print("\n%s [%s1%s]%s MASUKAN NOMOR HP %s(0895360913675)"%(G,R,G,Y,W))
		print("%s [%s2%s]%s JENIS HP/MEREK %s(INFINIX NOT 12) V1"%(G,R,G,Y,G))
		print("%s [%s3%s]%s HP DIPOSISI %s(CIKARANG BARAT.JLN MADURA) V2"%(G,R,G,Y,G))
		print("%s [%s4%s]%s DATA HP MU YANG HILANG SUDAH DI DAPATKAN %s(LETGO) V3"%(G,R,G,Y,G))
		print("%s [%s5%s]%s DATA SUDAH BENER BELOM %s(DIATAS)"%(G,R,G,Y,G))
		print("%s [%s6%s]%s HP MU MASIH DIPOSISI %s(CIKARANG) V1"%(G,R,G,Y,G))
		print(GET)
